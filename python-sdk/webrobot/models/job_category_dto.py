...
class JobCategoryDto(BaseModel):
    """
    JobCategoryDto
    """ # noqa: E501
    ...
    agent_ids: Optional[List[StrictStr]] = Field(default=None, alias="agentIds")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "icon", "visibility", "enabled", "agentIds", "createdAt", "updatedAt"]
