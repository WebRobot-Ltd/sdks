...
class ModelPublishRequest(BaseModel):
    ...
    ModelPublishRequest
    """ # noqa: E501
    local_model_path: Optional[StrictStr] = Field(default=None, alias="localModelPath")
    model_name: Optional[StrictStr] = Field(default=None, alias="modelName")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["localModelPath", "modelName", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localModelPath": obj.get("localModelPath"),
