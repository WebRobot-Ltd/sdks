...
class FormDataBodyPart(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "name", "value", "formDataContentDisposition", "simple", "parameterizedHeaders"]
