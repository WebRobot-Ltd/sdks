...
class AgenticProfile(BaseModel):
    ...
    spec_yaml: Optional[StrictStr] = Field(default=None, alias="specYaml")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    created_by_id: Optional[StrictInt] = Field(default=None, alias="createdById")
    __properties: ClassVar[List[str]] = ["id", "name", "version", "description", "organizationId", "enabled", "spec", "specYaml", "createdAt", "updatedAt", "createdById"]
