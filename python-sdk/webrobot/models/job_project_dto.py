...
class JobProjectDto(BaseModel):
    ...
    job_ids: Optional[List[StrictStr]] = Field(default=None, alias="jobIds")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "cronSchedule", "enabled", "jobIds", "createdAt", "updatedAt"]
