...
/**
 * DatasetUploadApiDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatasetUploadApiDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatasetUploadApiDto';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('headerline', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['headerline'];
    }

    /**
     * Sets headerline
     *
     * @param string|null $headerline headerline
     *
     * @return self
     */
    public function setHeaderline($headerline)
    {
        if (is_null($headerline)) {
            throw new \InvalidArgumentException('non-nullable headerline cannot be null');
        }
        $this->container['headerline'] = $headerline;
