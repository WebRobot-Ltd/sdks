 ...
 */
class MultiPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiPart';
    ...
    protected static $openAPITypes = [
        ...
        'providers' => 'object',
        'body_parts' => '\OpenAPI\Client\Model\BodyPart[]',
    ...
    */
     ...
     * Gets body_parts
     *
     * @return \OpenAPI\Client\Model\BodyPart[]|null
     */
     ...
     * Sets body_parts
     *
     * @param \OpenAPI\Client\Model\BodyPart[]|null $body_parts body_parts
     *
     * @return self
     */
    public function setBodyParts($body_parts)
    {
        if (is_null($body_parts)) {
            throw new \InvalidArgumentException('non-nullable body_parts cannot be null');
        }
