...
/**
 * TrainingRequestBean Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrainingRequestBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrainingRequestBean';
    ...
    protected static $openAPITypes = [
        ...
        'dataset_id' => 'string',
        'hyperparameters' => 'array<string,object>'
    ];
    ...
    */
     ...
     * Sets training_file
     *
     * @param string|null $training_file training_file
     *
     * @return self
     */
     ...
     *
     * @param string|null $validation_file validation_file
     *
     * @return self
     */
    public function setValidationFile($validation_file)
    {
        if (is_null($validation_file)) {
            throw new \InvalidArgumentException('non-nullable validation_file cannot be null');
        }
     ...
     *
     * @param array<string,object>|null $hyperparameters hyperparameters
     *
     * @return self
     */
