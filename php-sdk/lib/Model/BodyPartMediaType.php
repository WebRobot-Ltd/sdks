 ...
 */
class BodyPartMediaType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BodyPart_mediaType';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('wildcard_type', $data ?? [], null);
        $this->setIfExists('wildcard_subtype', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets wildcard_type
     *
     * @param bool|null $wildcard_type wildcard_type
     *
     * @return self
     */
    public function setWildcardType($wildcard_type)
    {
        if (is_null($wildcard_type)) {
            throw new \InvalidArgumentException('non-nullable wildcard_type cannot be null');
        }
     ...
     *
     * @param bool|null $wildcard_subtype wildcard_subtype
     *
     * @return self
     */
    public function setWildcardSubtype($wildcard_subtype)
    {
        if (is_null($wildcard_subtype)) {
            throw new \InvalidArgumentException('non-nullable wildcard_subtype cannot be null');
        }
